    ...
    <div className="w-full">
      ...
      <section className="  py-16 px-6 md:px-30 text-gray-700 leading-relaxed">
        ...
        <p className="mb-6">
          ...
          associated costs and liabilities. The Company accepts no
        ...
        <p className="mb-6">
          ...
          licenses from Nigerian regulatory authorities. The Company acts solely
          as a carrier and is not liable for delays or costs arising from
        ...
        <p className="mb-4">
          <strong>a. Standard Liability:</strong> The Company’s liability for
          loss or physical damage is limited to a maximum of <em>.........</em>{" "}
          per consignment, unless a higher declared value is made and premium
          insurance is purchased.
        </p>
        <p className="mb-4">
          <strong>b. Insurance Coverage:</strong> For goods exceeding the
          standard liability limit, the Customer must purchase premium insurance
          coverage through the Company or an independent insurer.
        </p>
        <p className="mb-6">
          <strong>c. Exclusions:</strong> The Company is not liable for damages
          caused by inadequate packaging, inherent defects of the goods, or
