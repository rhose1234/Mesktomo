...
export default function TermsPage() {
  return (
    <div className="w-full">
      {/* Hero Section */}
      <section className="h-[80vh] flex flex-col justify-center items-center text-center bg-greener text-white px-6">
      ...
      {/* Terms Content */}
      <section className="max-w-5xl mx-auto py-16 px-6 text-gray-800 leading-relaxed">
        <h2 className="text-2xl font-bold mb-6">1. Payment Terms</h2>
        <p className="mb-6">
        ...
        <h2 className="text-2xl font-bold mb-6">2. Prohibited Goods and Compliance</h2>
        <p className="mb-6">
          The Company will not transport goods that are illegal, dangerous, or otherwise prohibited 
          under the laws and regulations of the Federal Republic of Nigeria (FRN) or any transit country. 
        ...
        <h2 className="text-2xl font-bold mb-6">3. Customs and Regulatory Clearance</h2>
        <p className="mb-6">
        ...
        <h2 className="text-2xl font-bold mb-6">4. Insurance and Liability</h2>
        <p className="mb-4">
          <strong>a. Standard Liability:</strong> The Company’s liability for loss or physical damage is 
          limited to a maximum of <em>[NGN 50,000 or NGN 500/KG]</em> per 
        ...
        <h2 className="text-2xl font-bold mb-6">5. Packaging and Condition of Goods</h2>
        <p className="mb-6">
